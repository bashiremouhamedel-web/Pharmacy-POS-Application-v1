          ...
          <div class="row">
            ...
            <div class="col-3 text-right">
              <div id="cart-icon-count">
                <a href="add-purchase.php"><i class="fa-lg text-info fas fa-cart-plus"></i><span class="badge badge-warning"><?php echo isset($_SESSION["cart_item"]) ? count($_SESSION["cart_item"]) : 0; ?></span></a>
              </div>
            </div>
          </div>
          <div class="row">
